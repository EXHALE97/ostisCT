...
base_path=../picking_configurations/src
...
cp -Rfv $base_path/components/picking_configurations/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/picking_configurations/picking_configurations.js
